...
class OrdersPage(ctk.CTkFrame):
    """Orders management placeholder for future updates."""
    ...
    def create_layout(self) -> None:
        ...
        title = ctk.CTkLabel(header, text="Orders", font=("Segoe UI", 28, "bold"))
        title.pack(anchor="w")

        subtitle = ctk.CTkLabel(header, text="Manage orders and fulfillment (placeholder)", font=("Segoe UI", 12), text_color=TEXT_SECONDARY)
        ...
        add_btn = ctk.CTkButton(action_frame, text="New Order", width=140, fg_color="#16A34A")
        ...
        search_entry = ctk.CTkEntry(action_frame, placeholder_text="Search orders...")
        ...
        columns = ("ID", "Customer", "Product", "Qty", "Status", "Created")
    ...
    def _on_add(self) -> None:
        messagebox.showinfo("Not implemented", "Create order flow will be available in a future update.")

    def _on_import(self) -> None:
        messagebox.showinfo("Not implemented", "Import orders will be available in a future update.")
